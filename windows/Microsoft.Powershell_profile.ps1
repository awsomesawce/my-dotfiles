...
Function Node-Docs-Open {start https://nodejs.org/dist/latest-v14.x/docs/api/}
Set-Alias -Name nodedoc -Value Node-Docs-Open -Description "Open NodeJS docs in a browser"
