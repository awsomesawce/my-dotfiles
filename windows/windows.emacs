...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ivy-posframe magit-todos notmuch treemacs-magit treemacs-projectile helm-ag paper-theme posix-manual powerline powerline-evil prettier prism pydoc tldr treemacs-evil websocket dracula-theme evil-collection evil-test-helpers helm-emmet which-key flycheck evil-traces company-shell evil-org ac-emoji ac-helm ac-html evil-goggles evil-mc evil-mc powershell evil-tabs evil-tutor spacemacs-theme terminal-here toc-org vdiff company-nginx company-org-roam company-web counsel-css counsel-projectile css-autoprefixer dashboard didyoumean dired-git dired-k dired-recent dired-sidebar evil helm-org helm-projectile company coffee-mode auto-complete emmet-mode helm magit markdown-mode org-download ox-jekyll-md python-mode speed-type stylus-mode sublime-themes vs-dark-theme w3m web-mode-edit-element web-mode wgrep org-gtd org-index org-journal counsel ivy docbook gnu-elpa-keyring-update))
