...
(require 'evil)
(evil-mode 1)
;; Remember to switch out of evil-mode by using C-z
;; Eldoc prompts are not visible when in evil-insert mode.  They're only visible in emacs-mode
